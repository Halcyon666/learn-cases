...
import com.whalefall.learncases.netty.client.IMSConfig;
...
public class TCPReadHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        log.error("TCPReadHandler channelInactive()");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msgType == imsClient.getServerSentReportMsgType()) {
            ...
            log.info(String.format("服务端状态报告：「%d」, 1代表成功，0代表失败", statusReport));
            if (statusReport == IMSConfig.DEFAULT_REPORT_SERVER_SEND_MSG_SUCCESSFUL) {
                log.info("收到服务端消息发送状态报告，message=" + message + "，从超时管理器移除");
